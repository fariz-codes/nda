...
const _projectFields = (query) => {
  ...
  return { name, port, envvariables, projectpath, UID, startfilepath, pkginstallopt, jobsCount, bootstartopt, cpu: 'N/A', pid: 'N/A', createdAt: currentDateTime(), updatedAt: currentDateTime() };
};
