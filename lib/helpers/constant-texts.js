...
module.exports = {
  PROJECT: {
    ...
    Error: {
      ...
      SSL_MAP_ERR_WINDOWS: 'Failed to create ssl config. Please re-run the nda application with administrator privileges',
      SSL_MAP_ERR_LINUX: 'Failed to create ssl config. Please re-run the nda application as a `sudo` user',
      SSL_UNMAP_ERR_WINDOWS: 'Failed to delete ssl config. Please re-run the nda application with administrator privileges',
      SSL_UNMAP_ERR_LINUX: 'Failed to delete ssl config. Please re-run the nda application as a `sudo` user',
      SSL_FILES_ERR: 'There was a problem when trying to start NDA with SSL. Please check the provided SSL files. \n\nTrying to start NDA without the SSL..\n'
    },
    Success: {
